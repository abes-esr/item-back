...
public class TestTraitementService {
    ...
    void creerNouvelleZone() throws ZoneException {
        ...
        String result = tManager.creerNouvelleZone(noticeInit, "915", "$a", "1");
        assertThat(result).startsWith("e01 $a17-09-18$bx\r" +
                "915 $a1\r" +
                "930 ##$b341720001\r" +
                "991 ##$a");
    ...
    void creerNouvelleZoneWithRepeatableTag() throws ZoneException {
        StringBuilder noticeInit = new StringBuilder("e01 $a17-09-18$bx\r" +
                "930 ##$b341720001\r" +
                "A97 17-09-18 10:51:56.000\r" +
                "A98 341720001:17-09-18\r" +
                "A99 618828249\r").append(Constants.STR_0D).append(Constants.STR_0D);
    ...
    public void supprimerZone() throws ZoneException {
        ...
        String result = tManager.supprimerZone(notice, "991");
