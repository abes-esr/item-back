...
@SpringBootTest(classes = {LigneFichierExempService.class})
@ExtendWith({SpringExtension.class})
class LigneFichierExempServiceTest {
    @MockBean
    IZonesAutoriseesDao zonesAutoriseesDao;
    @MockBean
    TraitementService traitementService;
    @MockBean
    ILigneFichierExempDao iligneFichierExempDao;
    @Autowired
    ...
    @Test
    void getExempWithOneValue() throws ZoneException {
        String header = "930 $c";
        String valeur = "test";
        assertThat(ligneFichierExempService.creerExemplaireFromHeaderEtValeur(header, valeur, RCR, NUMEXEMP)).contains("e01 $bx\r" +
    ...
    @Test
    void getExempWithOneZoneAndTwoSousZones() throws ZoneException {
        String header = "930 $d;$c";
        String valeur = "testd;testc";
        assertThat(ligneFichierExempService.creerExemplaireFromHeaderEtValeur(header, valeur, RCR, NUMEXEMP)).contains(
                "e01 $bx\r" +
    ...
    @Test
    void getExempWithTwoZonesAndOneSousZone() throws ZoneException {
    ...
    @Test
    void getExempWithTwoZonesAndTwoSousZone() throws ZoneException {
    ...
    @Test
    void getExempWithThreeZonesAndTwoSousZone() throws ZoneException {
        String header = "E317 $a;E856 $u;$9;930 $j";
        String valeur = "DeGruyter LN;http://buadistant;2018-145;g;";
        String notice = ligneFichierExempService.creerExemplaireFromHeaderEtValeur(header, valeur, RCR, NUMEXEMP);
    ...
    @Test
    void getExempWithALotOfEverything() throws ZoneException {
        String header = "930 $d;$c;915 $a;$b";
        String valeur = "testd;testc;test2;test3";
        String notice = ligneFichierExempService.creerExemplaireFromHeaderEtValeur(header, valeur, RCR, NUMEXEMP);
    ...
    @Test
    void getExempWithALotOfEverything2() throws ZoneException {
    ...
    @Test
    void getExempWithMaxZonesAndSouszones() throws ZoneException {
        // GIVEN
    ...
    @Test
    void getExempWithSomeEmptyTag() throws ZoneException {
