...
public class Constant implements Serializable {
	...
	//Demande interompu
	public static final int ETATDEM_INTERROMPUE = 11;
	...
	public static final int MAX_LIGNE_FICHIER_INIT_MODIF = 5000;
	public static final int MAX_LIGNE_FICHIER_INIT_EXEMP = 5000;
	public static final int MAX_LIGNE_FICHIER_INIT_SUPP = 5000;
